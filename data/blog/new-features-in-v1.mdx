---
title: 'ویژگی‌های iOS 17'
date: 2021-08-07T15:32:14Z
lastmod: '2023-02-01'
tags: ['next-js', 'tailwind', 'guide']
mainPhoto: /static/images/test.png
draft: false
summary: 'در این مقاله به بررسی ویژگی‌های جدید iOS 17 که در کنفرانس اپل معرفی شد می‌پردازیم. این کنفرانس درواقع یکی از بهترین رویدادهای اپل در...'
layout: PostSimple
